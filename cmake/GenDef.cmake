...
macro(GEN_DEF NAME)
	...
	elseif(CMAKE_SYSTEM_NAME STREQUAL "AIX")
		...
		add_custom_command(
			TARGET ${NAME}
			PRE_LINK
			COMMAND ${NM_EXECUTABLE} ${FLAG_64} -BCg ${CMAKE_CURRENT_BINARY_DIR}/$<$<BOOL:${CMAKE_BUILD_TYPE}>:${CMAKE_FILES_DIRECTORY}>${NAME}.dir/${CMAKE_CFG_INTDIR}/*.o | egrep ' [TDB] ' | sed -e 's/.* //' | egrep -v '\$' | sed -e 's/^[.]//' | sort | uniq > ${CMAKE_CURRENT_BINARY_DIR}/${NAME}.exp
			COMMENT " Gen exports "
		)
	endif()
